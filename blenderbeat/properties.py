...
class BB_VisualProperties(bpy.types.PropertyGroup):
    ...
    preset: EnumProperty(
        ...
        items=[
            ('SIGNAL_DRIFT', "Signal Drift (Digital Apparition)", "Spectral human apparition dissolving into glowing light fragments, micro particles, and audio-reactive streaks"),
